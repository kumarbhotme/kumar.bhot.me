...
One of my school teachers used to say, "*When we understand something thoroughly, it becomes a part of us. We won’t need to remember it.*" That has remained the foundation of my learning to this day, thereby the underlying purpose of each of my readings. 
...
| About Face | Cooper, Alan; Reimann, Robert |
...
| Site Reliability Engineering | Murphy, Niall Richard; Beyer, Betsy |
| Design Patterns | Gamma, Erich; Helm, Richard |
| Seven Languages in Seven Weeks | Tate, Bruce; Tate, Bruce |
| Domain-Driven Design | Eric, Evans |
| How To Do Motivational Interviewing | Matulich, Bill; Matulich, Bill |
| Lean Software Development | Poppendieck, Mary; Poppendieck, Tom |
...
| Essential Scrum | S., Rubin Kenneth |
| Building a DevOps Culture | Walls, Mandi |
| Algorithms to Live By | Christian, Brian; Griffiths |
| Direct From Dell | Dell, Michael; Fredman, Catherine |
| Clean Code | C., Martin Robert |
...
| Scrum | Sims, Chris; Johnson, Hillary Louise |
| Inspired | Cagan, Marty |
| Mobile Usability | Nielsen, Jakob; Budiu, Raluca |
...
| Know-How | Charan, Ram |
| Your Time. Your Business. Your Life. | Mallis, Lisa Crilley |
| Everything Is Bullshit | Priceonomics |
| Thinking, Fast and Slow | Kahneman, Daniel |
| Crucial Conversations | Patterson, Kerry; Grenny, Joseph |
| Becoming a Technical Leader | Weinberg, Gerald |
| The Anatomy of Story | Truby, John |
| Mastering Web Application Development with AngularJS | Kozlowski, Pawel; Darwin, Peter Bacon |
| Public Speaking | Karia, Akash |
| SQL Cookbook | Molinaro, Anthony; Molinaro, Anthony |
| Don't Make Me Think | Krug, Steve |
| Database Design for Mere Mortals | J., Hernandez Michael |
...
| Start Small, Stay Small | Walling, Rob |
| Finding the Next Steve Jobs | Stone, Gene; Bushnell, Nolan |
| Sources of Power | Klein, Gary A. |
| Prioritizing Web Usability | Nielsen, Jakob; Loranger, Hoa |
| The 8 Pillars of Motivation | Brock, Farnoosh |
| Web Performance Daybook Volume 2 | Stefanov, Stoyan |
| The UX Book | Hartson, Rex; Pyla, Pardha S. |
| ReWork | Fried, Jason; Hansson, David Heinemeier |
| RESTful Web Services | Richardson, Leonard; Ruby, Sam |
...
| HTML5 for Masterminds | Gauchat, J.D. |
...
| Grounded | Erin Yu-Juin McMorrow PhD , |
| Teaming with Microbes | Jeff Lowenfels, Wayne Lewis |
| Teaming with Nutrients | Jeff Lowenfels, Wayne Lewis |
| Aboriginal Secrets of Awakening | Robbie Holz, Christiann Howard |
| How I Built This | Guy Raz |
| Origins | Donald Goldsmith, Neil deGrasse Tyson |
...
| Holistic Management | Jody Butterfield, Allan Savory |
...
| The Skeptic's Guide to American History | Mark A. Stoler, The Great Courses |
...
| The Hiding Place | Corrie ten Boom, Elizabeth Sherrill |
...
| Competing Against Luck | Clayton M. Christensen, Taddy Hall |
| Kama | Gurcharan Das |
...
| The Effective Executive | FlashNotes Book Summary |
...
| Understanding Japan | Mark J. Ravina, The Great Courses |
| The Other Side of History | Robert Garland, The Great Courses |
